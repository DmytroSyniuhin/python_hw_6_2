...
list_with_keys_in_both_dicts = [list(my_dict_1)[i] for i in range(len(my_dict_1))
                                if list(my_dict_1)[i] in list(my_dict_2)]

list_with_unic_keys_in_my_dict_1 = [list(my_dict_1)[i] for i in range(len(my_dict_1))
                                    if list(my_dict_1)[i] not in list(my_dict_2)]

dict_with_unic_keys_in_my_dict_1 = {
    list_with_unic_keys_in_my_dict_1[i]: my_dict_1.get(list_with_unic_keys_in_my_dict_1[i])
    for i in
    range(len(list_with_keys_in_both_dicts))}
